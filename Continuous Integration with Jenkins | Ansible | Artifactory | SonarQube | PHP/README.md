...
```
<img width="1178" height="502" alt="image" src="https://github.com/user-attachments/assets/4c0b4d9b-0d9b-47a7-93fd-5c196d7db48d" />

2. Plot the data using plot Jenkins plugin.
This plugin provides generic plotting (or graphing) capabilities in Jenkins. It will plot one or more single values variations across builds in one or more plots. Plots for a particular job (or project) are configured in the job configuration screen, where each field has additional help information. Each plot can have one or more lines (called data series). After each build completes the plots’ data series latest values are pulled from the CSV file generated by phploc

<img width="1053" height="521" alt="image" src="https://github.com/user-attachments/assets/816a09fb-1613-43e1-be23-64530bb583b7" />
